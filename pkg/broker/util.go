...
// Copied from https://github.com/operator-framework/operator-sdk-samples/blob/master/vault-operator/pkg/vault/util.go
...
func asOwner(br *api.Broker) metav1.OwnerReference {
	trueVar := true
